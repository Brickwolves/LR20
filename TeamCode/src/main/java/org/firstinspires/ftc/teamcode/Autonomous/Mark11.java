...
public class Mark11 extends LinearOpMode
{
    ...
    public void doPowerShot(VisionUtils.PowerShot powerShot){
        ...
        // Shoot
        double RPM = aimBot.calcRPM() - 400;
        if (powerShot == PS_MIDDLE) RPM -= 300;
    ...
    public void B(){
        ...
        while (time.seconds() < 2){
            ...
            double targetAngle = closestAngle(40, getAngle());
        ...
        robot.linearStrafe(220, 200, 0.5, 40, 0, 0, () -> {
            robot.arm.out();
    ...
    public void C(){
        ...
        robot.linearStrafe2Rings(180, 100, 0.3, 185, 0, 0, () -> {
        ...
        robot.linearStrafe2Rings(180, 400, 0.1, 185, 0, 0, () -> {
            robot.intake.rollerMidH();
            robot.intake.setRPM(INTAKE_RPM_FORWARDS);
        ...
        // Move fast a bit and intake
        robot.linearStrafe2Rings(180, 200, 0.3, 185, 0, 0, () -> {
            robot.intake.rollerMidH();
            robot.intake.setRPM(INTAKE_RPM_FORWARDS);
