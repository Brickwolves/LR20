...
public class Vis {
    ...
    public Vis(boolean isImageSavingEnabled, boolean redSide) {
        vuforia = new Vuforia();
    ...
    public SkyStoneConfigurations look(){
        ...
        if (isImageSavingEnabled) {
            /*Utils.saveImage(vuBitmap);
            Utils.saveImage(stone4);
            Utils.saveImage(stone5);
            Utils.saveImage(stone6);*/
        }
        ...
        telemetry.addData("Skystone 4 Ratio", ratio4);
        telemetry.addData("Skystone 5 Ratio", ratio5);
        telemetry.addData("Skystone 6 Ratio", ratio6);
        telemetry.update();
